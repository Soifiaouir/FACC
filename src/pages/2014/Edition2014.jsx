    ...
    const Edition2014 = () => {
        ...
        return (
            <div className="Edition 2014">
                ...
                <div>
                    <h3 className="H2014">Seconde Edition</h3>
                        <div className="hero2014">
                            ...
                            <img src={seconde} alt="invtation au second volet" className="Sec" />
                        </div>
                </div>

                <div className="M">
                    <h3 className="Ma">Présentation de la mariaine</h3>
                    <div className="maraine">
                        ...
                        <div className="sakina">
                            <iframe width="695" height="391" src="https://www.youtube.com/embed/RLRavL0nNQc" title="Pharrell Williams : dans sa version féministe ? - À l&#39;Affiche!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div className="A">
                    <h3> Dimention Artistique</h3>
                        <div className="dimArt">
                            <div className="greg">
                            <iframe width="695" height="391" src="https://www.youtube.com/embed/N_P5kbkEAfY" title="Arts martiaux d&#39;Afrique et d&#39;Outre-mer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                            <p>
                            ...
                            <div className="fat">
                            <iframe width="695" height="391" src="https://www.youtube.com/embed/f7O7cGdElJs" title="TV5 Monde - Festival d&#39;Arts Contemporains des Comores 2014" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                </div>
